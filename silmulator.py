...
PLAYFIELD   = 100000000/SCALE # Game over boundary WOW -im gonig to to infinti world
FPS         = 50         #50 Frames per second
ZOOM        = 2.7   #2.7        # Camera zoom
ZOOM_FOLLOW =True    #True       # Set to False for fixed view (don't use zoom)


TRACK_DETAIL_STEP =21/SCALE
TRACK_TURN_RATE =0.05  #0.31
TRACK_WIDTH =40/SCALE  #40/SCALE
#i change that because we dont want red borders in turns
    ...
    def _create_track(self):
        ...
        for c in range(CHECKPOINTS):
            ...
            if c==CHECKPOINTS-1:
                ...
                rad = 1.5*TRACK_RAD
            checkpoints.append((0,255,0) )  
            checkpoints.append( (alpha, rad*math.cos(alpha), rad*math.sin(alpha)) )
           
           # checkpoints.append((3.14,-1000,3) )  
